...
.gn-doc .atbl-h,.gn-doc .atbl-r,.gn-doc .atbl-t{display:grid;grid-template-columns:2.4fr .9fr 1.1fr 1.1fr .6fr;gap:10px;padding:8px 14px;align-items:center}
...
.gn-doc .atbl-d{line-height:1.3;overflow-wrap:anywhere}
